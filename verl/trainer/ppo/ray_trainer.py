...
class RayPPOTrainer:
    ...
    def _validate_config(self):
        ...
        def check_mutually_exclusive(mbs, mbs_per_gpu, name: str):
            settings = {
                ...
                "reward.reward_model": "micro_batch_size",
        ...
        if config.reward.reward_model.enable and not config.reward.reward_model.use_dynamic_bsz:
            check_mutually_exclusive(config.reward.reward_model.micro_batch_size, config.reward.reward_model.micro_batch_size_per_gpu, "reward.reward_model")
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            batch_keys_to_pop = [key for key in ["input_ids", "attention_mask", "position_ids"] if key in test_batch.batch.keys()]
            non_tensor_batch_keys_to_pop = [key for key in ["raw_prompt_ids"] if key in test_batch.non_tensor_batch.keys()]
    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                non_tensor_batch_keys_to_pop = [key for key in ["raw_prompt_ids"] if key in batch.non_tensor_batch.keys()]
                ...
                if self.async_rollout_mode:
                    # For agent loop, we need to repeat the input batch to get n generations
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("reward", timing_raw, color="yellow"):
                        ...
                        if self.config.reward.reward_model.launch_reward_fn_async:
